...
/* 消抖定时器回调函数：确认按键稳定按下后翻转LED + 更新按键状态并唤醒等待队列 */
...
MODULE_DESCRIPTION("noblockio module");
MODULE_LICENSE("GPL");