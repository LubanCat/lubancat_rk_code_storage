...
class MPU6050:
    ...
    def __init__(self, i2c):
        ...
        global lobal, mpu, acc, gyro

        self.i2c = i2c
        mpu = adafruit_mpu6050.MPU6050(self.i2c)
    ...
    def Kalman_threading(self):         #mpu6050定时器
        self.Kalman()
        threading.Timer(0, self.Kalman_threading).start()

    def start(self):
        self.Kalman_threading()
