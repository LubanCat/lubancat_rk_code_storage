 ...
 * @return: -1配置失败 0配置成功
*****************************/
static int pwm_config(motor_pwm pwmx, const char *attr, const char *val)
{
    char temp_path[100];
    int len;
    int fd;
...
*****************************/
static int pwm_init(motor_pwm pwmx)
{   
    char temp_path[100];
...
*****************************/
static int pwm_exit(motor_pwm pwmx)
{
    char temp_path[100];
